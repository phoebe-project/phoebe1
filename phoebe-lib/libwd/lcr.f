...
c  Version of January 8, 2003
     ...
     $,glog1,glog2,GR1,1,tloc1,tloc2,xInorm1,xInorm2)
     ...
     $GRYQ,GRZQ,MMSAVE,FR1,FR2,HLD,SNTH,CSTH,SNFI,CSFI,SUMM1,SM1,GRV1,
     $GRV2,XX1,YY1,ZZ1,XX2,YY2,ZZ2,CSBT1,CSBT2,GLUMP1,GLUMP2,GMAG1,GMAG2
     $,glog1,glog2,GR1,IFC,tloc1,tloc2,xInorm1,xInorm2)
   88 CONTINUE
     ...
     $GRV2,XX1,YY1,ZZ1,XX2,YY2,ZZ2,CSBT1,CSBT2,GLUMP1,GLUMP2,GMAG1,GMAG2
     $,glog1,glog2,GR2,1,tloc1,tloc2,xInorm1,xInorm2)
...
c~       write(*,*) d,vl1,vl2,pothd,potcd
   86 CONTINUE
     ...
     $potc,f2,d,snth,iband,tloc1,tloc2,xInorm1,xInorm2)
