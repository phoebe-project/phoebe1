...
#define wd_dc(atmtab,pltab,l3perc,knobs,indeps,fluxes,weights,nph,delph,corrs,errors,chi2s,cormat,params,cfval,args) dc_(atmtab,pltab,l3perc,knobs,indeps,fluxes,weights,nph,delph,corrs,errors,chi2s,cormat,params,cfval,args,strlen(atmtab),strlen(pltab))
