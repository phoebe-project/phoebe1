...
*/
    ...
    gui_widget_add ("phoebe_data_lc_cadence_switch",                    (GtkWidget *) gtk_tree_view_get_model ((GtkTreeView *) phoebe_data_lc_treeview),                        LC_COL_FTI,         GUI_WIDGET_VALUE,       phoebe_parameter_lookup ("phoebe_lc_cadence_switch"), NULL);
    gui_widget_add ("phoebe_data_lc_cadence",                           (GtkWidget *) gtk_tree_view_get_model ((GtkTreeView *) phoebe_data_lc_treeview),                        LC_COL_EXPTIME,     GUI_WIDGET_VALUE,       phoebe_parameter_lookup ("phoebe_lc_cadence"), NULL);
    gui_widget_add ("phoebe_data_lc_cadence_rate",                      (GtkWidget *) gtk_tree_view_get_model ((GtkTreeView *) phoebe_data_lc_treeview),                        LC_COL_OVERSAMPLING,GUI_WIDGET_VALUE,       phoebe_parameter_lookup ("phoebe_lc_cadence_rate"), NULL);
    gui_widget_add ("phoebe_data_lc_cadence_timestamp",                 (GtkWidget *) gtk_tree_view_get_model ((GtkTreeView *) phoebe_data_lc_treeview),                        LC_COL_TS_STR,      GUI_WIDGET_VALUE,       phoebe_parameter_lookup ("phoebe_lc_cadence_timestamp"), NULL);
